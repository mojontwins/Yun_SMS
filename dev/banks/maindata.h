...
#define						SS_PATTERNS_ENEMS_FIXED2_C_BIN_SIZE 0x0132

extern const unsigned char	ss_patterns_enems_fixed_c_bin [];
#define						SS_PATTERNS_ENEMS_FIXED_C_BIN_SIZE 0x0412

extern const unsigned char	ss_patterns_hud_c_bin [];
#define						SS_PATTERNS_HUD_C_BIN_SIZE 0x00E3

extern const unsigned char	ss_patterns_items_c_bin [];
#define						SS_PATTERNS_ITEMS_C_BIN_SIZE 0x02A1
