...
extern unsigned char cocoit;
extern signed int coco_x [COCOS_MAX], coco_y [COCOS_MAX];
extern signed int coco_vx [COCOS_MAX], coco_vy [COCOS_MAX];
extern unsigned char coco_flag [COCOS_MAX];

extern unsigned char rda, rdb, rdc, rdct;
extern unsigned char rdx, rdy, rdyn;
extern signed int rds16;

extern signed int px, py;
extern unsigned char prx, pry;
extern unsigned char pkilled, pstate;
