' mkts v 0.5.0 - Converts several kinds of tilesets
...
Dim Shared As Integer verbose, silent, mainIdx, cPoolIndex, tMapsIndex, flipped, upsideDown, clrIdx, blackiszero, columns, nextPattern, mirrored, simplemeta, supersimplemeta
Dim Shared As uByte mainBin (65535), clrBin (65535)
Dim Shared As String cPool (255)
Dim Shared As uByte tMaps (255, 63)
Dim Shared As uShort tMapsS (255, 63)
		...
		For x = x0 To x1 Step hSize
			...
			For yy = 1 To hMeta
				...
				For xx = 1 To wMeta
					...
					If patternIsAllZeroes (pattern ()) Then
						metapals (tMapI) = &HFF
					Else
						patternS = patternToString (pattern ())
...
Sub doScripted (inFileName As String, outFileName As String, platform As Integer) 
	...
	Dim As Integer max
	Dim As Integer xOrg, yOrg, wProc, hProc, wMeta, hMeta, sprxorg, spryorg
...
filteredPuts "mkts v0.5.0 20160605"
